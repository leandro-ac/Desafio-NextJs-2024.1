...
export default function Header() {
    return(
        <header className="bg-black sticky top-0 z-20 mx-auto w-full py-8 px-4 md:p-0 mb-8">
            ...
            <div className="flex items-center justfy-between w-full md:w-10/12 mx-auto">
             <Link href="/" className="flex gap-4 items-center px-4">
                 <Image src="/img/gkvaquinLogo.png" alt="logo" width={904} height={904} className="h-40 w-40 rounded-xl" />
             </Link>
